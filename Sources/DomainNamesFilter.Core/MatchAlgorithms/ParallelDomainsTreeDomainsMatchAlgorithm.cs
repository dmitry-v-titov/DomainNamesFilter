namespace DomainNamesFilter.Core.MatchAlgorithms
{
    ...
    /// </summary>
    public sealed class ParallelDomainsTreeDomainsMatchAlgorithm : IDomainsMatchAlgorithm
    {
        ...
        public IEnumerable<Domain> Match(IEnumerable<Domain> sourceDomains, IEnumerable<Domain> blackListDomains)
        {
            ...
            return sourceDomains.AsParallel().Where(sourceDomain => !domainsTree.Find(sourceDomain)).ToList();
        }
